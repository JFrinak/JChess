    ...
    public void redo(final Table.MoveLog moveLog){
        ...
        Collections.sort(whiteTakenPieces, new Comparator<Piece>() {
            ...
            public int compare(Piece o1, Piece o2) {
                Integer o1_PieceValue = new Integer(o1.getPieceValue());
                Integer o2_PieceValue = new Integer(o2.getPieceValue());
                return o1_PieceValue.compareTo(o2_PieceValue);
            }
        });
        ...
        for(final Piece takenPiece : whiteTakenPieces){
            try{
                String s = "art/simple/" + takenPiece.getPieceAlliance().toString().substring(0,1) +
